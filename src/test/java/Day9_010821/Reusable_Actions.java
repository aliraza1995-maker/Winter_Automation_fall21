...
public class Reusable_Actions {
    ...
    //create a reusable method for scroll by pixel
    ...
    //create a reusable select method

    public static void SendKey2Method(WebDriver driver, String xpath, String userData, String elementName){
        //declare local explicit wait
        WebDriverWait wait = new WebDriverWait(driver,15);
